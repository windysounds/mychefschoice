document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        food: {
            ko: [
                { name: '스시', description: '넌 지금 와사비가 필요해.' },
                { name: '갈비', description: '달콤하고 진한 맛을 느껴봐.' },
                { name: '빵 (베이커리)', description: '빵 하나면 충분해. 그래야 내일 고민 안 할 거야.' },
                { name: '샌드위치', description: '가장 맛있는 조합은 네 입이 알고 있어.' },
                { name: '치킨', description: '언제나 옳아. 바삭한 튀김을 느껴봐.' },
                { name: '김밥', description: '널 위한 선물 세트야. 야채를 챙겨야 할 때가 됐지?' },
                { name: '파스타', description: '면이 주는 위로를 느껴봐.' },
                { name: '피자', description: '다 함께 즐기는 최고의 선택!' },
                { name: '라면', description: '세상에서 가장 완벽한 국물 요리 중 하나.' },
                { name: '된장찌개', description: '구수한 맛이 일품인 한국인의 소울푸드.' },
                { name: '비빔밥', description: '다양한 야채와 고추장의 조화, 건강하고 든든하게.' },
                { name: '떡볶이', description: '매콤달콤한 맛으로 스트레스를 날려버려.' },
                { name: '제육볶음', description: '밥도둑이 여기 있었네. 말이 필요 없는 맛.' },
                { name: '부대찌개', description: '햄과 라면사리의 환상적인 콜라보!' },
                { name: '짜장면', description: '고민될 땐 그냥 짜장면으로 가자.' },
                { name: '짬뽕', description: '얼큰한 국물이 생각날 때, 최고의 선택.' },
                { name: '탕수육', description: '바삭함과 달콤함, 둘 다 놓칠 수 없지.' },
                { name: '마라탕', description: '요즘 대세! 얼얼한 맛에 중독될 준비 됐어?' },
                { name: '돈까스', description: '바삭한 튀김옷과 두툼한 고기의 완벽한 만남.' },
                { name: '카레', description: '향긋한 카레 향이 입맛을 돋울 거야.' },
                { name: '편의점 만찬', description: '오늘의 셰프는 바로 너! 최고의 조합을 만들어봐.' },
                { name: '볶음밥', description: '냉장고에 남은 재료도 훌륭한 요리가 될 수 있지.' },
                { name: '햄버거', description: '클래식한 맛의 정석, 빠르게 에너지를 채워봐.' },
                { name: '도시락', description: '정성스럽게 담은 한 끼 식사, 간단하고 든든하게.' },
                { name: '해물찜', description: '매콤한 양념에 버무린 신선한 해산물의 향연.' },
                { name: '안동찜닭', description: '짭짤하고 달콤한 간장 소스가 밴 닭고기와 당면.' },
                { name: '닭볶음탕', description: '매콤하고 칼칼한 국물, 밥 비벼 먹으면 최고지.' },
                { name: '칼국수', description: '구수한 국물과 쫄깃한 면발이 마음을 위로해줄 거야.' },
                { name: '만두', description: '찐만두, 군만두, 만둣국. 어떻게 먹어도 맛있지.' },
                { name: '닭갈비', description: '매콤한 양념에 볶아낸 닭고기, 볶음밥은 필수 코스.' },
                { name: '김치찌개', description: '잘 익은 김치와 돼지고기의 완벽한 조화. 밥 두 공기 예약!' },
                { name: '국밥', description: '뚝배기 한 그릇에 담긴 든든함, 마음까지 따뜻해져.' },
                { name: '순대국', description: '뜨끈한 국물에 속이 꽉 찬 순대, 든든함의 대명사.' },
                { name: '백반 정식', description: '매일 바뀌는 반찬의 즐거움, 집밥보다 더 집밥 같아.' },
                { name: '기사 식당 불백', description: '불패 신화여서 불백이야. 실패 없는 완벽한 한 끼.' },
                { name: '뷔페', description: '고민은 그만! 오늘만큼은 세상 모든 걸 맛보자.' },
                { name: '냉면', description: '냉면은 사실 사계절용이야. 이한치한, 이열치열!' },
                { name: '삼겹살', description: '대패든 뭐든 괜찮아. 일단 3겹. 지글지글 소리가 들리지?' },
                { name: '불고기', description: '달콤한 간장 양념의 정석, 남녀노소 모두의 사랑.' },
                { name: '덮밥', description: '흰 쌀밥 위에 펼쳐지는 맛의 향연, 한 그릇의 행복.' },
                { name: '감자탕', description: '진한 국물에 부드러운 등뼈, 술 안주로도 식사로도 최고.' },
                { name: '토스트', description: '바삭한 빵에 달콤한 잼, 간단하지만 완벽한 시작.' }
            ],
            en: [
                { name: 'Sushi', description: 'You need some wasabi right now.' },
                { name: 'Galbi (Korean BBQ Ribs)', description: 'Feel the sweet and rich flavor.' },
                { name: 'Bakery Bread', description: 'One bread is enough. So you won\'t worry tomorrow.' },
                { name: 'Sandwich', description: 'Your mouth knows the best combination.' },
                { name: 'Fried Chicken', description: 'It\'s always right. Feel the crispy crust.' },
                { name: 'Pasta', description: 'Feel the comfort that noodles give.' },
                { name: 'Pizza', description: 'The best choice to enjoy together!' },
                { name: 'Ramen', description: 'One of the most perfect soup dishes in the world.' },
                { name: 'Bibimbap', description: 'A harmony of various vegetables, healthy and satisfying.' },
                { name: 'Tteokbokki', description: 'Blow away stress with its spicy and sweet taste.' },
                { name: 'Jajangmyeon', description: 'When in doubt, just go for Jajangmyeon.' },
                { name: 'Malatang', description: 'The current trend! Ready to get addicted to the numbing taste?' },
                { name: 'Curry', description: 'The fragrant curry smell will whet your appetite.' },
                { name: 'Fried Rice', description: 'Leftover ingredients can become a great dish.' },
                { name: 'Hamburger', description: 'The standard of classic taste, quickly fill up your energy.' },
                { name: 'Donkatsu', description: 'The perfect meeting of crispy batter and thick meat.' },
                { name: 'Sweet and Sour Pork', description: 'Crispiness and sweetness, can\'t miss both.' },
                { name: 'Seafood Bake', description: 'A medley of ocean treasures, baked to perfection.' },
                { name: 'Bento Box', description: 'A perfectly balanced and beautiful meal box.' },
                { name: 'Taco Plate', description: 'Build your own happiness with fresh toppings.' },
                { name: 'Hot Dog', description: 'A simple classic that never disappoints.' },
                { name: 'Spaghetti Carbonara', description: 'Creamy, cheesy, and oh-so-satisfying.' },
                { name: 'Tomato Basil Pasta', description: 'Simple, fresh, and bursting with Italian sunshine.' },
                { name: 'Chicken Caesar Wrap', description: 'A healthy and delicious classic on the go.' },
                { name: 'Fish and Chips', description: 'Crispy battered fish and golden fries. A seaside classic.' },
                { name: 'Cajun Shrimp Bowl', description: 'Spicy, savory, and packed with flavor.' },
                { name: 'Grilled Cheese Sandwich', description: 'Golden toasted bread with a gooey, cheesy center.' },
                { name: 'Chicken Quesadilla', description: 'Cheesy, savory, and perfect for dipping.' },
                { name: 'Falafel Wrap', description: 'A delicious and healthy Mediterranean delight.' },
                { name: 'Pulled Pork Burger', description: 'Slow-cooked, tender, and smothered in BBQ sauce.' },
                { name: 'Breakfast Burrito', description: 'All your breakfast favorites wrapped in a warm tortilla.' },
                { name: 'Buffalo Wings', description: 'Tangy, spicy, and perfectly messy. Napkins required.' },
                { name: 'Chili', description: 'A hearty bowl of warmth and spice. Comfort in every spoonful.' },
                { name: 'Cobb Salad', description: 'A perfectly arranged masterpiece of flavors. Almost too pretty to eat.' },
                { name: 'BBQ Ribs', description: 'Fall-off-the-bone tender. Get your hands dirty.' },
                { name: 'Clam Chowder', description: 'A creamy, seaside classic. Perfect for a cool day.' },
                { name: 'Mac and Cheese', description: 'The ultimate comfort food. Pure, cheesy bliss.' },
                { name: 'Fried Green Tomatoes', description: 'A southern classic. Crispy, tangy, and delightful.' },
                { name: 'Jambalaya', description: 'A spicy celebration of rice and flavor from the bayou.' },
                { name: 'Shrimp Scampi', description: 'Garlicky, buttery shrimp over pasta. Simply elegant.' },
                { name: 'Beef Stew', description: 'Slow-cooked perfection. A hug in a bowl.' }
            ]
        },
