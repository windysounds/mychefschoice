document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        questions: [
            ...
            { id: 'q_staple', text: {ko: '가장 익숙한 주식은 무엇인가요?', en: 'What\'s your go-to carb?'}, options: [ 
                { text: {ko: '빵', en: 'Bread'}, tags: ['#빵', '#서양식'] }, 
                // ★★★★★ 오류 수정: '면요리' -> ['#면요리'] ★★★★★
                { text: {ko: '면', en: 'Noodles'}, tags: ['#면요리'] }, 
                { text: {ko: '밥', en: 'Rice'}, tags: ['#밥', '#아시안'] } 
            ]},
    ...
    function getRecommendation() {
        ...
        const foodList = translations.food[currentLang]; // 현재 언어에 맞는 음식 DB 사용
