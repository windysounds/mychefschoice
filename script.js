document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        staticPages: {
            ko: { navHome: "홈", navBlog: "My Chef의 이야기", navAbout: "소개", navPrivacy: "개인정보 처리방침", navContact: "문의하기", blogTitle: "My Chef의 이야기", about: `...`, privacy: `...`, contact: `...` },
            en: { navHome: "Home", navBlog: "My Chef's Story", navAbout: "About", navPrivacy: "Privacy Policy", navContact: "Contact", blogTitle: "My Chef's Story", about: `...`, privacy: `...`, contact: `...` },
            // ★★★ 블로그 데이터 추가 ★★★
            blog: [
                {
    ...
    function displayStaticPage(pageKey, lang) {
        ...
        // static-content가 아닌 pageContent에 내용을 채웁니다.
        pageContent.innerHTML = translations.staticPages[lang][pageKey];
    }
    
    function startGame() {
        switchView('home'); // 홈으로 돌아가서
    ...
    function getRecommendation() {
        ...
        resultTitle.textContent = translations.ui.result_title[currentLang];
